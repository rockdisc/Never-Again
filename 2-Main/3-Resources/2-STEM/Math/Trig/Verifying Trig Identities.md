...
Now we can put the LFS fraction together to get $\frac{\sin^2x+\cos^2x}{\cos x}$, the top part is one of the [[Trigonometric Identities]] which equals 1, so both sides would equal$\frac{1}{\cos x}=\frac{1}{\cos x}$ 
